...
export const NetworkConfigSchema = z.object({
    ...
    upstreamHttpProxy: z
        ...
        .url()
        .optional()
        .describe('URL of an upstream HTTP proxy to chain through (e.g., "http://127.0.0.1:3128"). ' +
...
export const SandboxRuntimeConfigSchema = z.object({
    ...
    allowBrowserProcess: z
        .boolean()
        .optional()
        .describe('Allow browser process operations (macOS only). Grants the additional Mach IPC, ' +
